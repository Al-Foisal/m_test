@extends('layouts')
@section('title', 'All withdrawal list')
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All withdrawal list</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr class="text-center">
                                            <td colspan="5">No withdrawal happend.</td>
                                        </tr>
                                    @endforelse
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('storeWithdrawal') }}" method="post">
                    @csrf
